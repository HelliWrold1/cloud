...
PROJECT_NAME := "github.com/HelliWrold1/cloud"
PKG := "$(PROJECT_NAME)"
...
install:
	...
	go install github.com/HelliWrold1/cloud/cmd/protoc-gen-go-gin@latest
	go install github.com/HelliWrold1/cloud/cmd/protoc-gen-go-rpc-tmpl@latest
